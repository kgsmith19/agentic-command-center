...
|---|---|---|---|---|---|---|---|---|---|---|
| T-U-001 | `tests/unit/test_x.py::test_y` | unit | PROP-001 -> FR-001 | <what breaks for a user if this is wrong> | <why a type/schema/lint rule cannot catch it> | <why no existing test covers it> | <YYYY-MM-DD, mutation used> | 12 | <condition under which this test is removed> | SL-003 |
...
|---|---|---|---|---|---|---|
| T-R-001 | <one sentence> | <date> | <which gate missed it> | <cause, not symptom> | SL-00x | <type/constraint added, or "no"> |
...
|---|---|---|---|---|
| T-U-0xx | <name> | <date> | duplicate / tested framework / no failure mode / superseded by DB constraint / dead code removed | <T- id, constraint, or "nothing needed"> |
