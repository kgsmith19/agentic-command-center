...
<!-- Copy to the repo root. Fill every <placeholder>. Keep this file under 120 lines forever. -->

## What this repo is

<One sentence, plain language. Same as PRD section 1.>
...
Full set and calibration: `rules/01-BUDGETS.md`.
